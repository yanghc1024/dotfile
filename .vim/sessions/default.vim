...
nnoremap ,fp :FloatermPrev
nnoremap ,fn :FloatermNext
nnoremap ,ft :FloatermNew
...
set ignorecase
set ruler
set runtimepath=~/.vim,~/.vim/plugged/gruvbox,~/.vim/plugged/auto-pairs,~/.vim/plugged/vim-cpp-enhanced-highlight,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-floaterm,~/.vim/plugged/vim-gutentags,~/.vim/plugged/vimtex,~/.vim/plugged/coc.nvim,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/plugged/vim-cpp-enhanced-highlight/after,~/.vim/plugged/vimtex/after,~/.vim/after
set shiftwidth=4
set showcmd
set showmatch
set smartcase
